...
import { Loader2, AlertCircle, Anchor, Calendar, User, Ship, Clock, FileText } from "lucide-react"; // Added FileText
import { useState } from "react"; // Added useState
import { CrewMemberWithDetails, Vessel } from "@shared/schema"; // Added types
